      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-lg text-primary-foreground/80 mb-10">
            Suscríbete para ofertas exclusivas, recetas y acceso anticipado a nuevos productos.
          </p>

          {isSubscribed ? (
            <div className="inline-flex items-center gap-3 bg-primary-foreground/10 backdrop-blur-sm rounded-full px-8 py-4">
              <Check className="w-5 h-5 text-primary-foreground" />
              <span className="text-primary-foreground">¡Bienvenido a la familia Aleymi!</span>
            </div>
          ) : (
